// All site content — typed constants from CONTENT.md
...
export const hero = {
  ...
  materialSliders: [
    ...
    { name: 'color',      default: '#ffffff', type: 'color' as const },
  ],
}
...
export const contact = {
  ...
  links: [
    { label: 'jshivangi86@gmail.com', href: 'mailto:jshivangi86@gmail.com', type: 'email' as const },
    { label: 'LinkedIn ↗',           href: 'https://linkedin.com/in/hardik-jaiswal', type: 'link' as const },
    { label: 'GitHub ↗',             href: 'https://github.com/GoDxVictoryRR', type: 'link' as const },
  ],
